...
const FullCard = ({ navigation }) => (
    <ScrollView>
        <Card>
            <Card.Content>
                <Title>
                    Велосипед STINGER GRAPHITE EVO 29" (2021), рама 22", черный
                </Title>
            </Card.Content>
            <Card.Cover
                source={{
            ...
            <Card.Content>
                <Paragraph style={{ marginTop: 10 }}>
                    ...
                    асфальтовым дорогам и пересечённой местности. Облегченная
                    рама выполнена из уникального алюминиевого сплава.
                </Paragraph>
                ...
                <Paragraph style={{ marginTop: 10 }}>
                    ...
                    {"\n"}
                    Наименование переднего переключателя - SHIMANO TOURNEY TY
                    {"\n"}
                </Paragraph>
            </Card.Content>
            <Card.Actions>
